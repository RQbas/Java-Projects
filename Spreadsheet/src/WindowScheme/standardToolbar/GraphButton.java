...
import WindowScheme.standardToolbar.graphComponents.Graph;
import WindowScheme.standardToolbar.graphComponents.GraphPoint;
...
public class GraphButton extends JButton {
    ...
    void createGraph() {
        try {
            Graph regularGraph = new Graph(getGraphPoints(), new Color(46, 133, 204), new Color(255, 0, 0));
            WorkArea.workAreaLayers.add(regularGraph, JLayeredPane.DRAG_LAYER, 0);
